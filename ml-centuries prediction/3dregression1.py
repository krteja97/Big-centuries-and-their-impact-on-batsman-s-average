...
list1 = cur.execute('select average - stddev2 from players where innings > 35 ');
...
xTrain, xTest, yTrain, yTest = train_test_split(x, average_list, test_size = 0.2, random_state = 0);
